...
#define _g_slist_alloc0()       tiny_slice_new0 (sizeof(GSList))
#define _g_slist_alloc()        tiny_slice_new (sizeof(GSList))
#define _g_slist_free1(slist)   tiny_slice_free (sizeof(GSList), slist)
